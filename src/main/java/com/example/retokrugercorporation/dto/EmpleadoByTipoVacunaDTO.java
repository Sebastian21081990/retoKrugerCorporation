...
@AllArgsConstructor
@Builder
@ApiModel(description = "Este dto representa los datos del empleado, si esta vacuna, el nro de dosis y cual es el tipo de vacuna")
public class EmpleadoByTipoVacunaDTO{
